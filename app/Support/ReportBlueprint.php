        ...
        return [
            ...
            'developer_investment' => [
                ...
                'fields' => [
                    ...
                    ['name' => 'local_units', 'label' => 'Local Units:', 'type' => 'number', 'step' => '1', 'auto_calc' => true],
                    ['name' => 'foreign_units', 'label' => 'Foreign Units :', 'type' => 'number', 'step' => '1', 'auto_calc' => true],
                    ['name' => 'local_investment_bn', 'label' => 'Local Investment (Rs in Billion) :', 'type' => 'number', 'step' => '0.01', 'auto_calc' => true],
                    ['name' => 'foreign_investment_bn', 'label' => 'Foreign Investment (Rs in Billion) :', 'type' => 'number', 'step' => '0.01', 'auto_calc' => true],
            ...
            'developer_tax_exemptions' => [
                ...
                'audiences' => ['developer'],
                'type' => 'dual_column',
                'column_labels' => ['For Developer', 'For Zone Enterprises'],
                'fields' => [
                    ['name' => 'dev_custom_duty_availed', 'label' => 'Custom Duty Exemption Availed :', 'type' => 'select', 'options' => ['Yes', 'No'], 'group' => 'developer'],
                    ['name' => 'dev_custom_duty_date', 'label' => 'Custom Duty Exemption Date :', 'type' => 'date', 'group' => 'developer'],
                    ['name' => 'dev_custom_duty_amount_mn', 'label' => 'Amount of Custom Duty Exemption (Rs in Millions) :', 'type' => 'number', 'step' => '0.01', 'group' => 'developer'],
                    ['name' => 'dev_income_tax_availed', 'label' => 'Income Tax Exemption Availed :', 'type' => 'select', 'options' => ['Yes', 'No'], 'group' => 'developer'],
                    ['name' => 'dev_income_tax_date', 'label' => 'Income Tax Exemption Date :', 'type' => 'date', 'group' => 'developer'],
                    ['name' => 'dev_income_tax_amount_mn', 'label' => 'Amount of Income Tax Exemption (Rs in Millions) :', 'type' => 'number', 'step' => '0.01', 'group' => 'developer'],
                    ['name' => 'ent_custom_duty_availed', 'label' => 'Custom Duty Exemption Availed :', 'type' => 'select', 'options' => ['Yes', 'No'], 'group' => 'enterprise'],
                    ['name' => 'ent_custom_duty_date', 'label' => 'Custom Duty Exemption Date :', 'type' => 'date', 'group' => 'enterprise'],
                    ['name' => 'ent_custom_duty_amount_mn', 'label' => 'Amount of Custom Duty Exemption (Rs in Millions) :', 'type' => 'number', 'step' => '0.01', 'group' => 'enterprise', 'auto_calc' => true],
                    ['name' => 'ent_income_tax_availed', 'label' => 'Income Tax Exemption Availed :', 'type' => 'select', 'options' => ['Yes', 'No'], 'group' => 'enterprise'],
                    ['name' => 'ent_income_tax_date', 'label' => 'Income Tax Exemption Date :', 'type' => 'date', 'group' => 'enterprise'],
                    ['name' => 'ent_income_tax_amount_mn', 'label' => 'Amount of Income Tax Exemption (Rs in Millions) :', 'type' => 'number', 'step' => '0.01', 'group' => 'enterprise', 'auto_calc' => true],
                ],
            ],
            'developer_production' => [
                ...
                'fields' => [
                    [
                        'name' => 'fiscal_years',
                        'label' => 'Fiscal Year Production Data',
                        'type' => 'table',
                        'columns' => [
                            ['name' => 'fiscal_year', 'label' => 'Fiscal Year', 'type' => 'text'],
                            ['name' => 'production_status', 'label' => 'Status', 'type' => 'select', 'options' => ['Production Started', 'Non-Production']],
                            ['name' => 'turnover_selected_fy_mn', 'label' => 'Turnover Actual (Rs M)', 'type' => 'number'],
                            ['name' => 'turnover_expected_fy_mn', 'label' => 'Turnover Expected (Rs M)', 'type' => 'number'],
                            ['name' => 'expected_exports_mn', 'label' => 'Exports Expected (Rs M)', 'type' => 'number'],
                            ['name' => 'generated_exports_mn', 'label' => 'Exports Generated (Rs M)', 'type' => 'number'],
                            ['name' => 'imports_mn', 'label' => 'Imports (Rs M)', 'type' => 'number'],
                            ['name' => 'production_mn', 'label' => 'Production (Rs M)', 'type' => 'number'],
                            ['name' => 'non_production_reason', 'label' => 'Non-Production Reason', 'type' => 'text'],
                        ],
                    ],
                    ['name' => 'total_companies_production', 'label' => 'Total Companies in Production :', 'type' => 'number', 'step' => '1', 'auto_calc' => true],
                    ['name' => 'total_companies_construction', 'label' => 'Total Companies in Construction :', 'type' => 'number', 'step' => '1', 'auto_calc' => true],
                ],
            ],
            ...
            'developer_enterprise_verification' => [
            ...
            'enterprise_production' => [
                ...
                'fields' => [
                    ...
                    ['name' => 'developer_verification_date', 'label' => 'Current Status Verification Date by Developer:', 'type' => 'date', 'developer_only' => true],
                ],
            ],
